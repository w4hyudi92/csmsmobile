...
import { DetailJualPartPage } from '../detailjualpart/detailjualpart';


@IonicPage()
@Component({
  selector: 'page-historijualpart',
  templateUrl: 'historijualpart.html',
  providers: [ApiProvider]
})
export class HistorijualpartPage {
  searchTerm: string = '';
  public param:any;
  ...
  select(item) {
      this.navCtrl.push(DetailJualPartPage, {
        isi: item,
      })
  }

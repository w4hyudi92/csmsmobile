...
import { FormservicebulletinPage } from '../formservicebulletin/formservicebulletin';
/**
 * Generated class for the listservicebulletin page.
 *
...
@IonicPage()
@Component({
  selector: 'page-listservicebulletin',
  templateUrl: 'listservicebulletin.html',
})
export class ListservicebulletinPage {
